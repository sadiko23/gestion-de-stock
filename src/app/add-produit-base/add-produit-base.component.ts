...
@Component({
  selector: 'app-add-produit-base',
  templateUrl: './add-produit-base.component.html',
  styleUrl: './add-produit-base.component.css'
})
export class AddProduitBaseComponent {
  public t: string="cProduitBase";
